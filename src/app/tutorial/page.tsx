    ...
    <main className="relative min-h-svh w-full overflow-hidden bg-background">
      ...
      <div className="relative z-20 flex flex-col min-h-svh items-center justify-center px-10">
        ...
        <header className="mb-12 text-center">
            ...
            <h1 className="text-2xl font-bold tracking-[0.3em] text-gold-bright uppercase">Tutorial</h1>
        </header>
...
function SimpleStep({ num, text }: { num: string, text: string }) {
  return (
    <li className="flex items-start gap-4">
      <span className="text-xl font-bold tracking-[0.2em] text-gold/40 border-b border-gold/20 pb-1">{num}</span>
      <p className="text-sm font-medium tracking-wide text-foreground/80 mt-1">{text}</p>
    </li>
  );
}
