...
export default function JoyConSandboxPage() {
    const { status, irFrame, joyconState, connect, disconnect } = useJoyCon();
    ...
    return (
        <div className="p-8 font-sans max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                ...
                <div className="p-6 bg-gray-50 border border-gray-200 rounded-xl shadow-sm">
                    <h2 className="text-xl font-semibold mb-4">3. IR クラスタ情報</h2>
                    {status === "CONNECTED" && irFrame ? (
                        <div>
                            <p className="text-sm text-gray-600 mb-2">
                                検出された光点の数: <span className="font-bold">{irFrame.clusters.length}</span>
                            </p>
                        ...
                        <div className="text-gray-500 text-sm">カメラ未接続またはデータ受信待ち...</div>
                    )}
                </div>
            </div>
        </div>
